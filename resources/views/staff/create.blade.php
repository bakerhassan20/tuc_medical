    ...
    <div class="container">
        ...
        <div class="row mb-5">
            <div class="col d-flex justify-content-start">
                <h4 class="main-heading mt-5">إضافة كادر هندسي جديد</h4>
            </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form class="parsley-style-1" id="createStaffForm" autocomplete="off" action="{{ route('staff.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
